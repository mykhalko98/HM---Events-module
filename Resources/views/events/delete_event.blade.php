     ...
     modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" onclick="confirmAjax.delete(this)" data-url="{{ route('events.event.delete', ['id' => $event_id])}}">{{ __('events::lang_admin.DELETE_BUTTON') }}</button>
